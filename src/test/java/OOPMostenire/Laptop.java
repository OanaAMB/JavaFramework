...
public class Laptop {
 //Incapsularea datelor = conceptul prin care tinem departe de exterior anumite avariabile si valorile acestora
 //private = este un access control care limiteaza accesul doar pentru aceasta clasa
 //Ca sa accesam/modificam variabilele/valorile ne folosim de conceptul get si set.
